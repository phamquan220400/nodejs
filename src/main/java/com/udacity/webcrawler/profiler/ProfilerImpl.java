...
final class ProfilerImpl implements Profiler {
    ...
    private Boolean checkProfiledClass(Class<?> classInstance) {
    ...
    public <T> T wrap(Class<T> classInstance, T delegate) {
        ...
        if (!checkProfiledClass(classInstance)) {
            throw new IllegalArgumentException("Profiled method does not found in " + classInstance.getName());
        }
